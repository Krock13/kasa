...
// Import the ShowArrows component to display left and right arrows for navigating the slider
...
export const ImageSlider = ({ slides }) => {
    ...
    return (
        <div className={styles.imageSliderContainer}>
            {/* Display the ShowArrows component to show the navigation arrows */}
            <ShowArrows
